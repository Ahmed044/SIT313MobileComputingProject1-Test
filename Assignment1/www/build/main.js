...
FavouritePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-favourite',template:/*ion-inline-start:"/Volumes/Data/FLP Data/Assignment Falak/PropertyAppCloned/SIT313MobileComputingProject1-Test/Assignment1/src/pages/favourite/favourite.html"*/'<!--\n  Generated template for the FavouritePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>favourite</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n<ion-list>\n        <ion-item *ngFor="let properties of properties">\n            <button ion-item>\n                <ion-thumbnail item-left>\n                    <img src="assets/prop1.jpg"/>\n                </ion-thumbnail>\n                <h2>{{properties.title}}</h2>\n                <p>{{properties.city}}, {{properties.state}} ∙ {{properties.price}}</p>\n            </button>\n            <ion-item-options>\n                <button danger (click)="deleteItem($event, property)">Delete</button>\n            </ion-item-options>\n        </ion-item>\n    </ion-list>\n\n</ion-content>\n'/*ion-inline-end:"/Volumes/Data/FLP Data/Assignment Falak/PropertyAppCloned/SIT313MobileComputingProject1-Test/Assignment1/src/pages/favourite/favourite.html"*/,
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_favourite_favourite__ = __webpack_require__(193);
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_9__pages_favourite_favourite__["a" /* FavouritePage */],
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Volumes/Data/FLP Data/Assignment Falak/PropertyAppCloned/SIT313MobileComputingProject1-Test/Assignment1/src/app/app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"/Volumes/Data/FLP Data/Assignment Falak/PropertyAppCloned/SIT313MobileComputingProject1-Test/Assignment1/src/app/app.html"*/
    }),
...
ListPage = ListPage_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-list',template:/*ion-inline-start:"/Volumes/Data/FLP Data/Assignment Falak/PropertyAppCloned/SIT313MobileComputingProject1-Test/Assignment1/src/pages/list/list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-left></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-right>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Volumes/Data/FLP Data/Assignment Falak/PropertyAppCloned/SIT313MobileComputingProject1-Test/Assignment1/src/pages/list/list.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]])
], ListPage);
...
LoginPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-login',template:/*ion-inline-start:"/Volumes/Data/FLP Data/Assignment Falak/PropertyAppCloned/SIT313MobileComputingProject1-Test/Assignment1/src/pages/login/login.html"*/'<!--\n  Generated template for the LoginPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n\n<ion-content class="background">\n	<ion-card>\n		<ion-card-header>\n			Login Form\n		</ion-card-header>\n		\n		<ion-card-content>\n			<ion-list no-lines>\n				<ion-item>\n					<ion-input type= "text" placeholder="username"></ion-input>\n				</ion-item>\n				\n				<ion-item>\n					<ion-input type= "text" placeholder="password"></ion-input>\n				</ion-item>\n			</ion-list>\n		\n			<button ion-button block (click)="navigateToHome()">Login</button>\n		</ion-card-content>\n\n	</ion-card>\n	\n	<button ion-button clear full color="light" (click)="navigateToSignUp()">Don\'t have an account? Signup</button>\n\n</ion-content>\n'/*ion-inline-end:"/Volumes/Data/FLP Data/Assignment Falak/PropertyAppCloned/SIT313MobileComputingProject1-Test/Assignment1/src/pages/login/login.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]])
], LoginPage);
